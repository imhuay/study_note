...
class Check:
    ...
    def is_complete(img):
        ...
        if Check.is_jpg(img):
            return Check.is_complete_jpg(img)
        elif Check.is_png(img):
            return Check.is_complete_png(img)
        else:
            return Check.is_complete_img(img)
...
if __name__ == '__main__':
    ...
    for file_name in os.listdir(dir_path):
        ...
        is_valid = Check.is_complete(file_path)
